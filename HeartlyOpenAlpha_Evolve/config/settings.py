...
LOCAL_MODEL_USE_QLORA = os.getenv("LOCAL_MODEL_USE_QLORA", "False").lower() == "true"
LOCAL_MODEL_TEMPERATURE = os.getenv("LOCAL_MODEL_TEMPERATURE", None)
LOCAL_MODEL_TOP_P = os.getenv("LOCAL_MODEL_TOP_P", None)
LOCAL_MODEL_TOP_K = os.getenv("LOCAL_MODEL_TOP_K", None)
